...
def main():
    ...
    # WEBHOOK_URL should be your Render service URL + /webhook
    # Example: https://your-bot.onrender.com/webhook
    render_port = int(os.environ.get("PORT", "10000"))
    webhook_url = os.environ.get("WEBHOOK_URL")

    if not webhook_url:
        print("\n" + "="*60)
        print("⚠️  WARNING: WEBHOOK_URL not set!")
        print("   Set it to: https://your-service.onrender.com/webhook")
        print("   Falling back to polling (will NOT work on Render free tier)")
        print("="*60 + "\n")
        app.run_polling(
