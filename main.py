...
def main():
    ...
    print('KeyShop Bot v4.5 - WEBHOOK RENDER READY')
    ...
    # WEBHOOK SETUP - v21 compatible, NO conflicting HTTP server
    ...
    # v21 compatible: Use Application.run_webhook() directly
    # This handles initialization internally - NO separate HTTP server needed
    app.run_webhook(
        listen="0.0.0.0",
        port=render_port,
