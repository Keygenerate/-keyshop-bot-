...
async def health_check(request):
    ...
    return web.Response(text="✅ KeyShop Bot v5.1 is alive!", status=200)
...
async def main_async():
    ...
    print('🚀 KeyShop Bot v5.1 - RENDER WEBHOOK + HEALTH CHECK FIX')
    print('🔧 API: ' + str(FIXED_API_URL))

    # Start auto-clear task - FIXED for python-telegram-bot v20+
